...
## Your Tasks
1. Transform this sales document into a STAGE-BASED coaching system
2. Save as JSON file with timestamp
...
- **Save to:** `D:\Projects\Ai\VoiceCoach-v2\rag\`
- **Filename format:** `DocumentName_YYYY-MM-DD_HH-MM-SS.json`
- **Content:** Valid JSON (no JavaScript syntax, no comments)
- **Example:** `NeverSplit_2024-01-06_14-30-45.json`

## Output Format

You must produce valid JSON that can be directly loaded. Structure it EXACTLY as follows:
