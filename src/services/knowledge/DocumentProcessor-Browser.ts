/**
 * Document Processor for VoiceCoach V2 - Browser Version
...
export class DocumentProcessorBrowser {
  ...
  constructor() {
    this.trail = new BreadcrumbTrail('DocumentProcessorBrowser');
  ...
  /**
   * Process document content directly (browser-compatible)
   */
  async processDocumentContent(content: string, fileName: string): Promise<ProcessedDocument> {
...
export const documentProcessorBrowser = new DocumentProcessorBrowser();