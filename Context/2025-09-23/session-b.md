...
Great! The formatting fix is working.

  Looking back at our conversation, the "really helpful data available that we might want to use
   later" refers to the rich coaching metadata that Ollama is returning in the JSON responses.
  Specifically:

  Available Rich Data Fields:
  - say_now - The immediate response to give
  - next_move - What to do after this response
  - path_goal - The strategic objective of this conversation path
  - predicted_response - What the prospect will likely say next
  - alternative - Alternative approaches if the main one doesn't work
  - conversation_path - Which sales technique/path this follows
  - current_trigger - What triggered this coaching suggestion
  ...
  - conversation_path - Could show which sales framework is being applied
  - current_trigger - Could help users understand why this suggestion appeared
  - Priority/confidence scoring
  - Stage progression indicators
  - Customer type classifications

  This rich metadata could power features like:
  - Coaching explanations - "Why am I being told to say this?"
  - Strategy visualization - Show the sales framework being used
  - Confidence indicators - How certain the AI is about this suggestion
  - Learning mode - Explain the sales psychology behind each move

  Would you like to explore using any of this additional data to enhance the coaching
  experience?
